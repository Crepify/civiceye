...
export function EmptyState({ icon, title, description, action }: EmptyStateProps) {
  return (
    ...
    >
      <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary-500/15 to-emerald-500/15 text-primary-600 dark:text-primary-400">
        {icon}
      </div>
