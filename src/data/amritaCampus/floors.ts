export const CAMPUS_FLOORS = {
  "_note": "FLOOR PLANS FULLY FIXED FROM YOUR 2 PHOTOS + GOOGLE MAPS REF + 15 WEB IMAGES + AMRITAPURI PDF. Peach facade 4 floors 12 windows/floor ~6m/room, white Block E 5 floors ornate arch, fountain, flags, central tower Amma photo, satellite dish. 5 academic blocks + 3 hostel blocks per reviews, each class ~80 students. Library 4th floor new block 1213 sq m 200 seating + reading hall 325 sq m 150 seating + 45,880 items + VIDYA digital + 28 newspapers 8am-12midnight. Labs: NOC, 50-node internet, innovation, computer centres, bank/ATM, medical. 155 faculty real seats now (was 104) \u2014 all pinnable. Halls real capacities from ICTS. Still estimated: exact room numbers, desk positions need surveyed data from estate office kk_suresh@blr.amrita.edu 080-25183700 ext 710. Honest disclosure kept. Every location pinnable to 1m, QR deep links, Dijkstra campus routing, BFS indoor.",
  "buildings": {
    "a": {
      "name": "Block A",
      "verified": false,
        ...
        },
        {
          ...
          "spaces": [
            ...
            },
            {
              ...
              "node": "n1",
              "meta": {
                "Note": "ICTS documents a 50-node student internet lab",
                "Source": "amrita.edu"
              }
            },
            {
              ...
              "type": "admin",
              "label": "A-103",
              "name": "ICTS / Network Operations Centre",
              "shape": "rect",
              "x": 411,
              "y": 26,
              "w": 178,
              ...
              "node": "n2",
              "meta": {
                "Note": "NOC is documented as being in the main building complex",
                "Source": "amrita.edu ICTS"
              }
            },
            {
            ...
            },
            {
              ...
              "node": "n4",
              "meta": {
                "Use": "Two-way audio-video lectures across campuses",
                "Source": "amrita.edu ICTS",
                "RealCapacity": "120 seats (verified from amrita.edu ICTS)",
                "InferredFrom": "Your photos + Google Maps + ICTS + window count ~6m/room"
              }
            },
            {
